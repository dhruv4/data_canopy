...
def run_vary_chunk_size(filename,outfile,start,end,num_col,size_col,num_threads):
	os.system("rm "+outfile)
	for i in range(start,end):
		size_chunk = pow(10,i)
		print " ../bin/"+ filename + " " + str(num_col) + " " + str(size_col) + " " +str(size_chunk)+ " " +str(num_threads)+ " >>" + outfile + " 2>&1"
...
def run_vary_column_number(filename,outfile,start,end,size_col,size_chunk,num_threads):
	os.system("rm "+outfile)
	for i in range(start,end):
		num_col = i
		print " ../bin/"+ filename + " " + str(num_col) + " " + str(size_col) + " " +str(size_chunk)+ " " +str(num_threads)+" >>" + outfile + " 2>&1"
