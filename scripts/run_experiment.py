...
if vary_column_number:
	...
	exp.run_vary_column_number("test",path_raw+folder_name+"/"+file_name+raw_ext,5,8,100000,10,1)
...
if vary_column_size:
	...
	exp.run_vary_column_size("test",path_raw+folder_name+"/"+file_name+raw_ext,4,10,15,1000)
	exp.parseFile(path_raw+folder_name+"/"+file_name+raw_ext)
...
if vary_chunk_size:
	...
	exp.run_vary_chunk_size("test",path_raw+folder_name+"/"+file_name+raw_ext,1,6,15,1000000)
	exp.parseFile(path_raw+folder_name+"/"+file_name+raw_ext)

	p.Plot(path_raw+folder_name+"/"+file_name+raw_ext+csv_ext,'size_chunk',['level_one_time','level_two_time','rest_of_levels_time','total_time'],path_raw+folder_name+"/"+file_name,True,False)
	p.Plot(path_raw+folder_name+"/"+file_name+raw_ext+csv_ext,'size_chunk',['level_one_time','level_two_time','rest_of_levels_time','total_time'],path_raw+folder_name+"/"+file_name,True,True)
